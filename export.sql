--------------------------------------------------------
--  File created - пятница-мая-29-2020   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "C##ATS"."ADDRESSNUMBER_SEQ2"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 141 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence ADRESSNUMBERID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "C##ATS"."ADRESSNUMBERID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 9 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "C##ATS"."LOGINS_SEQ1"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 121 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence NUMBER_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "C##ATS"."NUMBER_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 63 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "C##ATS"."PAYMENT_SEQQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 164 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "C##ATS"."SUBSCSEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 164 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into C##ATS.ADDRESSNUMBER (ID,INDX,NUMB,STREET,HOME,APARTMENT,IDTYPEPLACE,AREA,TELTYPE) values ('103','3880',null,'33','323','32','1','akadem','1');
Insert into C##ATS.ADDRESSNUMBER (ID,INDX,NUMB,STREET,HOME,APARTMENT,IDTYPEPLACE,AREA,TELTYPE) values ('21','123','43','12v','12','11','1','msk','1');
Insert into C##ATS.ADDRESSNUMBER (ID,INDX,NUMB,STREET,HOME,APARTMENT,IDTYPEPLACE,AREA,TELTYPE) values ('104','6580',null,'12','22235','545','1','fgfg','1');
Insert into C##ATS.ADDRESSNUMBER (ID,INDX,NUMB,STREET,HOME,APARTMENT,IDTYPEPLACE,AREA,TELTYPE) values ('121','2357','8','vla','54','33','2','d23',null);
Insert into C##ATS.ADDRESSNUMBER (ID,INDX,NUMB,STREET,HOME,APARTMENT,IDTYPEPLACE,AREA,TELTYPE) values ('105','8383','49','bulvar','124','78','1','afa','1');
Insert into C##ATS.ADDRESSNUMBER (ID,INDX,NUMB,STREET,HOME,APARTMENT,IDTYPEPLACE,AREA,TELTYPE) values ('1','122',null,'V1','12','1','2','NN','1');
...
SET DEFINE OFF;
Insert into C##ATS.LOGINS (ID,LOGIN,PASSWORD,ISLOGGEDIN,ROLE) values ('4','tester','123','Y','21');
Insert into C##ATS.LOGINS (ID,LOGIN,PASSWORD,ISLOGGEDIN,ROLE) values ('41','Aaa','123','N','21');
Insert into C##ATS.LOGINS (ID,LOGIN,PASSWORD,ISLOGGEDIN,ROLE) values ('2','or','123','N','21');
...
Insert into C##ATS.LOGINS (ID,LOGIN,PASSWORD,ISLOGGEDIN,ROLE) values ('101','dworker1','123','Y','22');
...
SET DEFINE OFF;
Insert into C##ATS.PAYMENTS (ID,LASTPAYMENT,LASTMESSAGE,DEBT,MOUNTHCOST,INTERCITYDEBT,INTERCITYLASTMESSAGE,INTERCITYCALLCOST,MESSAGE) values ('44',to_date('05.03.20','DD.MM.RR'),null,'0','10','0',null,'1',null);
Insert into C##ATS.PAYMENTS (ID,LASTPAYMENT,LASTMESSAGE,DEBT,MOUNTHCOST,INTERCITYDEBT,INTERCITYLASTMESSAGE,INTERCITYCALLCOST,MESSAGE) values ('84',to_date('11.04.20','DD.MM.RR'),null,'0','0','0',null,'0',null);
Insert into C##ATS.PAYMENTS (ID,LASTPAYMENT,LASTMESSAGE,DEBT,MOUNTHCOST,INTERCITYDEBT,INTERCITYLASTMESSAGE,INTERCITYCALLCOST,MESSAGE) values ('27',to_date('05.03.20','DD.MM.RR'),null,'10','0','0',null,'0','var est');
Insert into C##ATS.PAYMENTS (ID,LASTPAYMENT,LASTMESSAGE,DEBT,MOUNTHCOST,INTERCITYDEBT,INTERCITYLASTMESSAGE,INTERCITYCALLCOST,MESSAGE) values ('5',to_date('28.02.20','DD.MM.RR'),null,'10','10','0',null,'0',null);
...
Insert into C##ATS.PAYMENTS (ID,LASTPAYMENT,LASTMESSAGE,DEBT,MOUNTHCOST,INTERCITYDEBT,INTERCITYLASTMESSAGE,INTERCITYCALLCOST,MESSAGE) values ('64',to_date('05.03.20','DD.MM.RR'),null,'0','0','0',null,'0',null);
Insert into C##ATS.PAYMENTS (ID,LASTPAYMENT,LASTMESSAGE,DEBT,MOUNTHCOST,INTERCITYDEBT,INTERCITYLASTMESSAGE,INTERCITYCALLCOST,MESSAGE) values ('124',to_date('19.04.20','DD.MM.RR'),null,'0','0','0',null,'0',null);
Insert into C##ATS.PAYMENTS (ID,LASTPAYMENT,LASTMESSAGE,DEBT,MOUNTHCOST,INTERCITYDEBT,INTERCITYLASTMESSAGE,INTERCITYCALLCOST,MESSAGE) values ('144',to_date('19.04.20','DD.MM.RR'),null,'0','0','0',null,'0',null);
...
Insert into C##ATS.SUBSCLOGIN (LOGIN,SUBSCID) values ('41','84');
Insert into C##ATS.SUBSCLOGIN (LOGIN,SUBSCID) values ('2','27');
...
Insert into C##ATS.SUBSCLOGIN (LOGIN,SUBSCID) values ('81','124');
Insert into C##ATS.SUBSCLOGIN (LOGIN,SUBSCID) values ('101','144');
REM INSERTING into C##ATS.SUBSCRIBER
SET DEFINE OFF;
Insert into C##ATS.SUBSCRIBER (ID,ADRESSNUMBER,INTERCITYENABLED,CAUSE,SUBTYPEID,PAYMENTID,SERVICEENABLED,AGE,NAME,SECOND_NAME) values ('44','105','Y',null,'1','44','Y','12','da','fat');
Insert into C##ATS.SUBSCRIBER (ID,ADRESSNUMBER,INTERCITYENABLED,CAUSE,SUBTYPEID,PAYMENTID,SERVICEENABLED,AGE,NAME,SECOND_NAME) values ('84',null,'N',null,null,'84','N',null,'darya','ysova');
Insert into C##ATS.SUBSCRIBER (ID,ADRESSNUMBER,INTERCITYENABLED,CAUSE,SUBTYPEID,PAYMENTID,SERVICEENABLED,AGE,NAME,SECOND_NAME) values ('27',null,'N',null,null,'27','N','22','da','eet');
Insert into C##ATS.SUBSCRIBER (ID,ADRESSNUMBER,INTERCITYENABLED,CAUSE,SUBTYPEID,PAYMENTID,SERVICEENABLED,AGE,NAME,SECOND_NAME) values ('5','21','N','pay','1','5','Y','22','dd','der');
Insert into C##ATS.SUBSCRIBER (ID,ADRESSNUMBER,INTERCITYENABLED,CAUSE,SUBTYPEID,PAYMENTID,SERVICEENABLED,AGE,NAME,SECOND_NAME) values ('104',null,'N',null,null,'104','N',null,'darya','123');
Insert into C##ATS.SUBSCRIBER (ID,ADRESSNUMBER,INTERCITYENABLED,CAUSE,SUBTYPEID,PAYMENTID,SERVICEENABLED,AGE,NAME,SECOND_NAME) values ('28',null,'N',null,null,'28','N','34','las','kdeb');
Insert into C##ATS.SUBSCRIBER (ID,ADRESSNUMBER,INTERCITYENABLED,CAUSE,SUBTYPEID,PAYMENTID,SERVICEENABLED,AGE,NAME,SECOND_NAME) values ('64',null,'N',null,null,'64','N','56','das','tester');
Insert into C##ATS.SUBSCRIBER (ID,ADRESSNUMBER,INTERCITYENABLED,CAUSE,SUBTYPEID,PAYMENTID,SERVICEENABLED,AGE,NAME,SECOND_NAME) values ('124',null,'N',null,null,'124','N',null,null,null);
Insert into C##ATS.SUBSCRIBER (ID,ADRESSNUMBER,INTERCITYENABLED,CAUSE,SUBTYPEID,PAYMENTID,SERVICEENABLED,AGE,NAME,SECOND_NAME) values ('144',null,'N',null,null,'144','N',null,null,null);
Insert into C##ATS.SUBSCRIBER (ID,ADRESSNUMBER,INTERCITYENABLED,CAUSE,SUBTYPEID,PAYMENTID,SERVICEENABLED,AGE,NAME,SECOND_NAME) values ('1','1','N',' ','1','2','Y','12','clad','tester');
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index ADDRESSNUMBER_UK2
--------------------------------------------------------

  CREATE UNIQUE INDEX "C##ATS"."ADDRESSNUMBER_UK2" ON "C##ATS"."ADDRESSNUMBER" ("NUMB") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##ATS"."ADDRESSNUMBER_UK3" ON "C##ATS"."ADDRESSNUMBER" ("INDX", "STREET", "HOME", "APARTMENT", "AREA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.ID IS NULL THEN
      SELECT ADDRESSNUMBER_SEQ2.NEXTVAL INTO :NEW.ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##ATS"."ADDRESSNUMBER" ADD CONSTRAINT "ADDRESSNUMBER_UK2" UNIQUE ("NUMB")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "C##ATS"."ADDRESSNUMBER" ADD CONSTRAINT "ADDRESSNUMBER_UK3" UNIQUE ("INDX", "STREET", "HOME", "APARTMENT", "AREA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
